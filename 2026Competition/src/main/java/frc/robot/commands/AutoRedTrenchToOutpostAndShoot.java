...
public class AutoRedTrenchToOutpostAndShoot extends SequentialCommandGroup {
  /** Creates a new AutoRedTrenchToOutpostAndShoot. */
  public AutoRedTrenchToOutpostAndShoot() {
